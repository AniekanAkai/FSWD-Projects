...
austinpowers1= media.Movie(
	"Austin Powers: International Man of Mystery", #noqa
...
austinpowers2= media.Movie(
	"Austin Powers: The Spy Who Shagged Me", #noqa
...
favouriteMovies = {
	greenStreetHooligans, #noqa
	austinpowers1,  #noqa
	austinpowers2,  #noqa
	austinpowers3,  #noqa
	aclockworkorange,  #noqa
	_300spartans} #noqa
